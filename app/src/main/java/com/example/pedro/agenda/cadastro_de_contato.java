...
public class cadastro_de_contato extends AppCompatActivity {
    ...
    void abrirMapas(){
        ...
        if(intentMapa.resolveActivity(getPackageManager())!=null) {
            ...
            Toast toast = Toast.makeText(cadastro_de_contato.this, "Não foi possivel abrir o aplicativo de Mapas", Toast.LENGTH_LONG);
            toast.show();
        }
    }
    ...
    void abrirCamera(){
        ...
        if(intentCamera.resolveActivity(getPackageManager())!=null) {
            ...
            Toast toast = Toast.makeText(cadastro_de_contato.this, "Não foi possivel abrir o aplicativo de Camera", Toast.LENGTH_LONG);
            toast.show();
        }
